...
-- 1. In this query, we create a Reference Portfolio in LUSID
...
select 'uk-equity-model';

-- Define the portfolio data
@create_portfolio =

select 'Reference' as PortfolioType, @@portfolioScope as PortfolioScope, @@portfolioCode1 as
