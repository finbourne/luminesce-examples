...
@transactions = 
values
(@@scope, @@portfolioCode, 'csh_001', 'FundsIn', '2023-01-01', '2023-01-01', 1000000, 1, 1000000, 'GBP', 'CCY_GBP', 1),
(@@scope, @@portfolioCode, 'csh_002', 'FundsIn', '2023-01-01', '2023-01-01', 1000000, 1, 1000000, 'USD', 'CCY_USD', 0.79);
