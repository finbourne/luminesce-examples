...
@new_properties_excel = use Drive.Excel
--file=/luminesce-examples/fi_instrument_master.xlsx
--worksheet=properties
enduse;

@newProperties = select
('Instrument/' || Scope || '/' || PropertyCode) as column1,
iif(DataType = 'string', 'Text', 'Decimal') as column2,
PropertyCode as column3,
PropertyCode as column4
from @new_properties_excel;
